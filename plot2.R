...
plot(mydat2$DateTime, mydat2$Global_active_power, type = "n", 
     xlab = "", ylab = "Global Active Power (kilowatts)")              ## create the plot in the screen device, display only the axes and titles 
lines(mydat2$DateTime, mydat2$Global_active_power)                     ## add the lines to the plot
dev.copy(png, file = "plot2.png")                                      ## copy the plot as a png file in the cwd  
dev.off()
